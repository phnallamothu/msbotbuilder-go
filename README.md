...
[![Build Status](https://travis-ci.org/phnallamothu/msbotbuilder-go.svg?branch=develop)](https://travis-ci.org/phnallamothu/msbotbuilder-go) [![GoDoc](https://godoc.org/github.com/phnallamothu/msbotbuilder-go?status.svg)](https://godoc.org/github.com/phnallamothu/msbotbuilder-go)
...
```sh
$ go get -u github.com/phnallamothu/msbotbuilder-go/...
```
