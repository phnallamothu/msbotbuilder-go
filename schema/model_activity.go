...
// Activity constants for various activity types - these are string constants for reference only
// Use ActivityTypes for type checking
const (
	// ActivityTypeMessage represents a regular message activity
	ActivityTypeMessage = "message"
	// ActivityTypeMessageUpdate represents a message update activity
	ActivityTypeMessageUpdate = "messageUpdate"
	// ActivityTypeMessageDelete represents a message delete activity
	ActivityTypeMessageDelete = "messageDelete"
	// ActivityTypeConversationUpdate represents a conversation update activity
	ActivityTypeConversationUpdate = "conversationUpdate"
	// ActivityTypeMessageReaction represents a message reaction activity
	ActivityTypeMessageReaction = "messageReaction"
	// ActivityTypeEvent represents an event activity
	ActivityTypeEvent = "event"
	// ActivityTypeInvoke represents an invoke activity
	ActivityTypeInvoke = "invoke"
	// ActivityTypeInvokeResponse represents an invoke response activity
	ActivityTypeInvokeResponse = "invokeResponse"
	// ActivityTypeEndOfConversation represents an end of conversation activity
	ActivityTypeEndOfConversation = "endOfConversation"
	// ActivityTypeTyping represents a typing activity
	ActivityTypeTyping = "typing"
	// ActivityTypeInstallationUpdate represents an installation update activity
