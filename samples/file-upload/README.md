...
This Microsoft Teams bot example uses the [msbotbuilder-go](https://github.com/phnallamothu/msbotbuilder-go) library. It shows how to handle `invoke` activity and upload local file from Bot to use.
